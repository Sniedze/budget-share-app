...
export const parseSettlementPeriod = (value: unknown): SettlementPeriodValue => {
  if (typeof value === 'string' && SETTLEMENT_PERIODS.includes(value as SettlementPeriodValue)) {
    return value as SettlementPeriodValue;
  }
  return 'CurrentMonth';
};
